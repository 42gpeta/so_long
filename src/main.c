...
/*   Updated: 2023/05/01 15:06:29 by gpeta            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	printf("PLAYER POSITION : [%d][%d]\n", data->gen.player.pos_y, data->gen.player.pos_x); // ! a supprimer
	printf("EXIT POSITION : [%d][%d]\n", data->gen.player.pos_exit_y, data->gen.player.pos_exit_x); // ! a supprimer
}
