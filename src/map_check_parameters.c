...
/*   Updated: 2023/04/10 16:53:34 by glodi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_surrounded_by_one_up(t_generate *generate, t_data *data) // ? v2
{
    int x;
...
void	ft_check_surrounded_by_one_down(t_generate *generate, t_data *data) // ? v2
{
    int x;
...
void	ft_check_surrounded_by_one_left(t_generate *generate, t_data *data) // ? v2
{
    int y;
...
void	ft_check_surrounded_by_one_right(t_generate *generate, t_data *data) // ? v3
{
    int y;
