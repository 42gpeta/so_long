...
/*   Updated: 2023/03/30 19:10:38 by gpeta            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_surrounded_by_one(t_generate *generate, t_data *data) // ? v2  // TODO finir la vérif des côtés
{
	...
	i = 0;
	generate->map.up = ft_substr(generate->string_map_ber, 0, (ft_strlen(generate->string_map_ber) - ft_strlen(ft_strchr(generate->string_map_ber, '\n'))));
	...
	if (generate->map.up[i] != '1' || generate->map.down[i] != '1')
		ft_message_error("Wall on top or on bottom is not complete.", data, generate);
